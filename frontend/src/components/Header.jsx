    ...
    >
      <div className="container mx-auto flex justify-between items-center p-4">
        ...
        <Link to="/" className="flex items-center space-x-2">
          <img
            src="/kalchakra-logo.png"  // Make sure this image is in the public/ folder
            alt="Kalchakra Logo"
            className="h-14 w-14 object-contain"
          />
          <span className="text-3xl font-bold text-black">Kalchakra</span>
        </Link>
        ...
        <nav
          ...
          } md:static md:flex-row md:w-auto md:translate-x-0 -ml-44`}
        >
          <Link
            to="/"
        ...
        {/* Mobile Menu Toggle and User Icon */}
