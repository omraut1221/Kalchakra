...
<body>
  <div class="header">
    <h1>Verify Your Email with Kalchakra</h1>
  </div>
  <div class="content">
    <p>Hello,</p>
    ...
    <p>Best regards,<br>The Kalchakra Team</p>
  </div>
  <div class="footer">
...
<body>
  ...
  <div class="content">
    <p>Hello,</p>
    <p>Your password has been successfully reset for your Kalchakra account.</p>
...
<body>
  ...
  <div class="content">
    <p>Hello,</p>
    <p>We received a request to reset your Kalchakra account password. If this was not you, please ignore this message.</p>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to Kalchakra</title>
  <style>
    body {
      font-family: Arial, sans-serif;
      line-height: 1.6;
...
<body>
  <div class="header">
    <h1>Welcome to Kalchakra</h1>
  </div>
  <div class="content">
    <p>Hello,</p>
    <div class="welcome-message">Welcome to the Kalchakra community!</div>
    <p>Thank you for joining Kalchakra. We’re excited to have you with us and look forward to providing a seamless experience.</p>
